...
function FormEditarEquiposHijosCom() {
    ...
    const EditarEquipo = async (e) => {
        ...
        try {            
            const res = await clienteAxios.put('/equipo/categoria/'+id, equipo,{
                headers: {
            ...
            Swal.fire({
                title: 'Se actualizo correctamente el insumo/equipo',
                text: res.data.msg,
                type: 'success',
                timer: 3500
            });
            ...
            // redireccionar
            navigate('/equiposcom/' + idEmpresa, {replace: true});
        } catch (error) {
            console.log(error)
            Swal.fire({
                type: 'error',
    ...
    const consultarAPI = async ()  => {
        ...
        try {            
            ...
            const resEquipo = await clienteAxios.get('/equipo/categoria/' + id,{
                headers: {
                    Authorization: `Bearer ${auth.token}`
                }
            });
            console.log(resEquipo)
            guardarEquipo(resEquipo.data)
        ...
        <Fragment>
            <div className="card contenedor">
                <div className="card-header-com">
                    ...
                    <h1>Editar Sub Insumo/Equipo "{nombrePadre}"</h1>
                </div>
                <div className="card-body">

                    <div className='top-left'>
                        <Link to={'/equiposcom/' + idEmpresa} className="btn-new btn-return"><IoArrowBackCircleOutline size={25}/> Regresar</Link>
                    </div>
...
export default FormEditarEquiposHijosCom