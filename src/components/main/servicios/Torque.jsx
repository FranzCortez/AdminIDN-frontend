            ...
            <footer className="footer">
                ...
                <div className="footer__grid" id="footer">
                    ...
                    <div className="footer__ubicacion">
                        ...
                        <a href="https://maps.app.goo.gl/U7RBdPsn7eAU4nQL7" target="_blank" className="footer__a" rel="noreferrer"><SiGooglemaps size={15} color={"#e1e1e1"}/>&nbsp; Gran Avenida Radomiro Tomic 7176, Antofagasta</a>
