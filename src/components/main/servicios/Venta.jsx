    ...
    return (
        <div className="back__main">
            ...
            <header className="servicio__header">
                ...
                <h1 className="servicio__titulo">Venta y arriendo de equipos diversos</h1>
            ...
            <main className="venta">
                ...
                <p> Como complemento a nuestros servicios de mantención y reparación,  ofrecemos a nuestros clientes el arriendo de equipos <strong>(principalmente hidráulicos, neumáticos y de torque, así como generadores, etc.)</strong>, con costos especiales para arriendos mensuales.</p>
